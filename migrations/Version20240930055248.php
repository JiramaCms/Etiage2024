 ...
 */
final class Version20240930055248 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE site_source (site_id INT NOT NULL, source_id INT NOT NULL, INDEX IDX_2F24D12CF6BD1646 (site_id), INDEX IDX_2F24D12C953C1C61 (source_id), PRIMARY KEY(site_id, source_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
