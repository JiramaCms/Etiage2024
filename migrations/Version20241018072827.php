 ...
 */
final class Version20241018072827 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        //$this->addSql('ALTER TABLE site CHANGE coord coord POLYGON NOT NULL');
        $this->addSql('ALTER TABLE station ADD coord POINT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE site CHANGE coord coord POLYGON DEFAULT NULL COMMENT \'(DC2Type:polygons)\'');
