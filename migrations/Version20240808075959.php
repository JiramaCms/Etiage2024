 ...
 */
final class Version20240808075959 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE materiel CHANGE capasite capacite INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE materiel CHANGE capacite capasite INT DEFAULT NULL');
