 ...
 */
final class Version20241001140504 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE site CHANGE coord coord POINT NOT NULL, CHANGE code code VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE site CHANGE coord coord POINT NOT NULL COMMENT \'(DC2Type:points)\', CHANGE code code INT DEFAULT NULL');
